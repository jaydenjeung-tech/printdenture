    ...
    <div className="min-h-screen bg-[#F8F7F4]">
      ...
      <div className="h-14 border-b border-[#E2E0D8] bg-white flex items-center justify-between px-6">
        <div className="flex items-center gap-4">
          ...
          <span className="text-xs font-medium bg-[#1A1A1A] text-white px-2 py-0.5 rounded">Admin</span>
        </div>
        <Link href="/dashboard">
          <Button variant="ghost" size="sm" className="text-sm text-[#6B6B6B]">Customer view</Button>
        </Link>
      </div>
